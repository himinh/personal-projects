...
<template>
  ...
  >
    ...
    <span class="title"
      ...
      <img
        v-if="menu.isLive"
        class="hidden ml-1 pb-0.5 md:inline"
...
.menu-item {
  ...
  @apply flex items-center bg-transparent px-3 py-5 font-medium leading-5 text-[var(--navigation-text)];
  ...
  .title {
    @apply hidden ml-1.5 overflow-hidden;
  }

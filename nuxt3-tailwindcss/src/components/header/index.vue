  ...
  <header class="sticky top-0 w-full">
    <div class="flex w-full justify-between">
      <div class="mr-4 flex flex-1 items-center">
        ...
        <form class="form-search ml-4 flex-1">
          <div class="relative flex">
            <div
              class="absolute flex h-full w-[40px] items-center justify-center"
            >
              <el-icon :size="26">
                <Icon name="bx:search" />
              </el-icon>
      ...
      <div class="header-right ml-4">
        <el-icon
          :size="38"
          class="cursor-pointer rounded-full bg-[var(--alpha-bg)] p-2"
        >
...
input {
  @apply h-[40px] w-full  rounded-full px-3  text-sm text-[var(--text-primary)] outline-0 placeholder:text-[var(--text-placeholder)];

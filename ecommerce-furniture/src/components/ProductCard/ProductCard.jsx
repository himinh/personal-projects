...
const ProductCard = (props) => {
  ...
  return (
    <div
      data-aos="fade-up"
      className="product-card pb-5 d-flex flex-column col-12 col-md-4 col-lg-3"
    >
      ...
      <div className="product-info px-3 d-flex flex-column">
        ...
        <div className="product-prices d-flex">
          {oldPrice ? (
            <>
              <del className="product-price pe-2">{formatToVND(oldPrice)}</del>
              <span className="product-price">{formatToVND(price)}</span>
            </>
          ) : (
            <span className="product-price">{formatToVND(price)}</span>
          )}
